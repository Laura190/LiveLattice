...
def process_data(tif_path_list, save_path_list, specified_channels, selected_psf_path, folders_to_process, frames_to_process, save_mip, overwrite_file, use_dask, num_decon_it, skewed_decon, decon_zsection_size, decon_deskew_rotate, no_decon, decon_only):
